<script context="module" lang="ts">
	import ButtonSocial from 'pages/Auth/ButtonSocial.svelte';
...
<div class="grid lg:grid-cols-2 xl:grid-cols-3 bg-auth bg-cover">
	<div class="min-h-screen flex items-center justify-center bg-white py-12 px-4 sm:px-6 lg:px-8">
		<div class="max-w-md w-full space-y-8">
			...
			<div>
				<label for="title" class="block text-sm font-medium leading-5 text-gray-700 mb-1"
					>Sign in with</label
				>
			...
			<form class="mt-8 space-y-6" action="#" method="POST">
				...
				<div>
					...
					<input class={INPUT_STYLES} id="password" type="password" />
				</div>
